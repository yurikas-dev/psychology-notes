...
1. **Direction** — clarifies where to focus your attention
2. **Effort** — higher goals drive greater effort
3. **Persistence** — makes it easier to push through obstacles
4. **Strategy** — encourages you to think about how to achieve the goal
